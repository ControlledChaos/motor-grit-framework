...
$site_title = apply_filters( 'mg_site_title', $title );
...
$site_description = apply_filters( 'mg_site_description', $description );
...
$logo = apply_filters( 'mg_logo', $output );

/**
 * Output header content.
 */
do_action( 'mg_before_header_content' ); ?>
...
<?php do_action( 'mg_after_header_content' );