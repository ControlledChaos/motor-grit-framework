        ...
        <article class="hentry" id="post-<?php the_ID(); ?>" role="article">
            ...
            <?php if ( '' !== get_the_post_thumbnail() ) : ?>
                <div class="post-thumbnail">
                    ...
                    $size = apply_filters( 'mg_blog_thumbnail_size', 'medium' );
                    $args = apply_filters( 'mg_blog_thumbnail_args', [
                        'class' => 'alignnone'
                    ] );
                ...
                <?php if ( 'excerpt' == mg_sanitize_blog_content_format( get_theme_mod( 'mg_blog_content_format' ) ) ) {
                    the_excerpt();
                } else {
                    the_content();
                } ?>
